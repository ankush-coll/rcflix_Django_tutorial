...
from appmovie.views import frontpage,user_likes,remove_like,register,verify_otp, movies_trending,search_multi, person_info, movie_details, series,series_details
urlpatterns=[
    ...
    path("list/", user_likes, name="list"),
     path('list/remove/<int:movie_id>/', remove_like, name='remove_like'),
]